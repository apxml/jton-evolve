# EVOLVE-BLOCK-START
"""
JSON Compressor v27 - Optimized prefix detection

Key improvements:
1. Keep v26 as base
2. Smarter prefix detection (min 2 chars instead of 3)
3. Pack floating point sequences more efficiently
4. Optimize base64 threshold for strings
"""
