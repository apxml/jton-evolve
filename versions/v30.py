# EVOLVE-BLOCK-START
"""
JSON Compressor v30 - Keep best v26 with minor tweaks

Key improvements:
1. Same as v26 (best so far)
2. Minor optimization: base64 threshold at 12
"""
...
class JSONCompressor:
    ...
    def _c(self, v: Any) -> Any:
        if isinstance(v, dict):
            ...
            if len(v) > 12:  # Slightly lower threshold
