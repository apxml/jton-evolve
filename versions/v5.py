# EVOLVE-BLOCK-START
"""
JSON Compressor v5 - Delta Encoding for Numbers

Key improvements:
1. Store numeric arrays as deltas when beneficial
2. Detect sequential IDs and compress them
3. Keep best parts of v4
"""
...
class JSONCompressor:
    ...
    def _is_sequential(self, numbers: List[Union[int, float]]) -> bool:
        ...
        return len(set(deltas)) == 1  # All deltas are the same
