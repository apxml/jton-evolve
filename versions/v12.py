# EVOLVE-BLOCK-START
"""
JSON Compressor v12 - Compress ALL keys

Key improvements:
1. Set min_key_length to 3 to compress more keys
2. Even short keys get compressed if used multiple times
"""
...
class JSONCompressor:
    ...
    def __init__(self):
        ...
        self.key_counter = 0
        self.min_key_length = 3  # Lower threshold
