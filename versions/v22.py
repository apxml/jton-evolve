# EVOLVE-BLOCK-START
"""
JSON Compressor v22 - Optimized binary packing with prefix codes

Key improvements:
1. Use single-char prefix codes instead of strings like "b:", "d:", etc
2. Pack booleans into bits
3. More aggressive key compression (0-length threshold)
