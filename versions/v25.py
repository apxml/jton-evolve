# EVOLVE-BLOCK-START
"""
JSON Compressor v25 - Optimal binary packing without overhead

Key improvements:
1. Keep successful v22 as base
2. Add unsigned byte packing for IDs
3. More aggressive constant threshold (2+ items)
4. Optimize format selection logic
"""
...
class JSONCompressor:
    """Optimal binary packing compression."""
    ...
    def _pack_nums(self, nums: List[Union[int, float]]) -> str:
        """Pack numbers optimally."""
        # Unsigned bytes for positive small ints (common for IDs)
